...
function setI18nLanguage (lang) {
  i18n.locale = lang
  const vxeLang = storage.get('lang')
    console.log('vxeLang', vxeLang === 'en_US')
  // 对组件内置的提示语进行国际化翻译
  VXETable.setup({
    i18n: (key, args) => XEUtils.toFormatString(XEUtils.get(vxeLang === 'en_US' ? vxeEnUS : vxeZhCN, key), args)
  })
